...
import { getAllUsers, toggleBanUser, deleteUser, downloadCSV } from "../../services/adminService";
  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-4">
        {users.map((user) => (
          <div key={user._id} className="rounded-2xl border border-gray-200 bg-violet-100/20 p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6 shadow-md">
